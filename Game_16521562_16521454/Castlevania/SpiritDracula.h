...
#define SPIRITDRACULA_JUMP_SPEED_X	0.1f
...
#define SPIRITDRACULA_JUMP_HEIGHT				90.0f

#define SPIRITDRACULA_WAIT_TIME				2000
#define SPIRITDRACULA_PRE_JUMP_TIME			200
#define SPIRITDRACULA_JUMP_TIME				300
#define SPIRITDRACULA_LANDING_TIME			100
