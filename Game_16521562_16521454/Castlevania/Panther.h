...
#define PANTHER_STATE_WALKING_RIGHT 300
#define PANTHER_STATE_WALKING_LEFT  400
#define PANTHER_STATE_JUMP_RIGHT    500
#define PANTHER_STATE_JUMP_LEFT     600
#define PANTHER_STATE_DIE			700
#define PANTHER_STATE_DELETE		800
